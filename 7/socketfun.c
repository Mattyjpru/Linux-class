...
int accept_connection(int sockfd)
{
  ...
  // declared because otherwise next line is too long, waaah.
...
int request_connection(char *hostname, int port)
{
  ...
  // now this is the OTHER machine
  // the NULL means no 'hints'
